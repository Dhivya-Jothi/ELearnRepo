	...
	public partial class SIgnUpPage : System.Web.UI.Page
	{
		...
		protected virtual void SignUp_Page(object sender, EventArgs e)
		{
			...
			using (SqlCommand insertCommand = new SqlCommand(command, dbConnection))
			{
				...
				insertCommand.Parameters.AddWithValue("@mailId", txtMail.Text);
				insertCommand.Parameters.AddWithValue("@mobileNumber", txtMobileNumber.Text);
				...
				insertCommand.Parameters.AddWithValue("@mediumOfStudy", txtMediumOfStudy.Text);
				dbConnection.Open();
